...
but limited to the language that they use. 
There is currently no studies on language-agnostic formalizations of 
mapping processes. 
...
ensuring verified correctness and supporting optimization across different
mapping languages.
...
operators which can be composed together to formally describe the mapping
processes. 
Lastly, we provide an algorithm for translating RML document
...
Section~\ref{sec:related_works} provides an overview of related works at 
