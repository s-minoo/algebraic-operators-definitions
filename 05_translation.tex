...
%
    An implementation of the algorithm, evaluated with the official RML test cases~\footnote{RML test case: \url{https://rml.io/test-cases/}}, shows that our formal semantics align with informal semantics from the RML spec. 
