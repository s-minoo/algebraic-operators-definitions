...
In addition to providing a basis for defining the semantics of a mapping language such as RML formally, our mapping algebra may also be used as a foundation for implementing such languages in mapping tools. In order for such tools ... more efficient mapping plans .. equivalences that may be used to rewrite initial mapping plans into more efficient ones. While an extensive study of such optimization opportunities is beyond the scope of this paper, in this section we show a few such equivalences to highlight the ..

TODO (Olaf) some introduction text here (motivation and outline)
