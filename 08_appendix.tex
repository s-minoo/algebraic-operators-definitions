...
\QueryLabel{lst:sparql_tm_singlepom}{Normalization step~\ref{item:NormalizationStep:TMDuplication1} (duplicate triples maps that contain multiple pred\-i\-cate-ob\-ject maps).}
    \end{minipage}
\vspace{-2mm}
    \begin{minipage}[t]{0.5\textwidth}
{
...
\QueryLabel{lst:sparql_graphmap_norm:1}{Normalization step~\ref{item:NormalizationStep:TMDuplication2}a (duplicate triples maps with subject maps in cases in which the associated pred\-i\-cate-ob\-ject maps may contain multiple graph~maps).}
    \end{minipage}
    \hspace{2mm}
    \begin{minipage}[t]{0.5\textwidth}
{
