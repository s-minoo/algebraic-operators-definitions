...
\vspace{-2mm}
    \begin{minipage}[t]{\textwidth}
\begin{lstlisting}[language=sparql, caption={Normalization step~\ref{item:NormalizationStep:TMDuplication2}a (duplicate triples maps with subject maps in cases in which the associated pred\-i\-cate-ob\-ject maps may contain multiple graph~maps).},
...
\vspace{-2mm}
    \begin{minipage}[t]{\textwidth}
\begin{lstlisting}[language=sparql, caption={Normalization step~\ref{item:NormalizationStep:TMDuplication2}b (duplicate subject maps
