\begin{algorithm}[htbp]
	...
	\label{alg:query_extraction}
		...
		$\symRMLGraph_\mathsf{tm} \gets$ the $\triplesMapIRI_\mathsf{tm}$-rooted subgraph of $\symRMLGraph$ \tcc*{Definition~\ref{def:rooted_subgraph}} \\

        $Q \gets \emptyset$ \tcc*{Initially empty set of query expressions} \\
