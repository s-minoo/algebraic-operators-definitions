...
\begin{definition}
	...
	and let $\symJoinAttrPairs \subset \symAttrSubSet_{1} \times \symAttrSubSet_{2}$
	such that $(\fragAttr, \fragAttr) \in \symJoinAttrPairs$.
	The \textbf{$\symJoinAttrPairs$-specific equijoin of mapping relations $r_{1}$ and
        $r_{2}$}, denoted by $\fctEquiJoinOp{r_{1}}{r_{2}}$,is the mapping relation $(\symAttrSubSet', \symMappingInst')$
