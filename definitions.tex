...
\begin{definition}
	...
	The \textbf{natural join of mapping relations $r_{1}$ and
        $r_{2}$}, denoted by $\fctNatJoin{r_{1}}{r_{2}}$, is the mapping relation $(\symAttrSubSet', \symMappingInst')$
	such that $\symAttrSubSet' = \symAttrSubSet_{1} \cup \symAttrSubSet_{2}$
	and
	\begin{align*}
		\symMappingInst' & =  \{ \mappingTuple_1 \cup \mappingTuple_2 \ | \
...
\begin{definition}
	...
	Let $r_{1} = \mappingRelSpec{1}$ and
	$r_{2} = \mappingRelSpec{2}$ be mapping relations.
	The \textbf{union of mapping relations $r_{1}$ and
        $r_{2}$}, denoted by $\fctUnion{r_{1}}{r_{2}}$, is the mapping relation $(\symAttrSubSet', \symMappingInst')$
	such that $\symAttrSubSet' = \symAttrSubSet_{1} \cup \symAttrSubSet_{2}$
	and
	\begin{align*}
