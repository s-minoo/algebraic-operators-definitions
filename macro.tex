...
\newcommand{\equiJoinOp}{\text{EqJoin}^{\symJoinAttrPairs}}
\newcommand{\triplesMapIRI}{u}
% \newcommand{\triplesMapGraph}[2]{\symRMLGraph_{#1}^{#2}}  %%% Not needed anymore.  --Olaf
...
\newcommand{\baseIRI}{\mathit{base}}
\newcommand{\literal}{\ell}
\newcommand{\lex}{\mathit{lex}}
\newcommand{\dt}{\mathit{dt}}
\newcommand{\literalTuple}{(\lex, \dt)}
\newcommand{\LTB}{\mathit{S2B}}
\newcommand{\tempSubStrs}{\textsc{Split}}
...
\newcommand{\fctExtFuncEvalN}[2]{\extFunc\bigl(\fctEval{#1_1}{#2},\dots,\fctEval{#1_n}{#2}\bigr)}
...
\newcommand{\fctToIRI}[2]{\toIRI(#1,#2)} % arguments: term, base IRI
...
\newcommand{\fctConcatBig}[2]{\concat\bigl( #1, #2 \bigr)}
...
\newcommand{\fctUnionBig}[2]{\union\bigl(#1,#2\bigr)}

% Other symbols %
%\newcommand{\containedIn}{\Subset} % to be used to express that a data object is contained in another data object


% Layout %
\newcommand{\ttl}[1]{\texttt{\small #1}}  % for conrete IRIs, etc. used in examples and in formulas
\newcommand{\ttlSmaller}[1]{\texttt{\scriptsize #1}}  % for conrete IRIs, etc. used in examples and in formulas
\newcommand{\ttsf}[1]{\textsf{\small #1}}
