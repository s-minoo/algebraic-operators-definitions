...
\newcommand{\symSetDataset}%
	%{\symDatasetUni_\mathrm{ds}}
	{\mathcal{D}^\texttt{\tiny ds}\!}
...
\newcommand{\sourceTypeTuple}
	%{(\symSetDataset, \symDataAcc, \eval, \cbeval)}
	{(\symSetDataset\!, \symDataAcc, \eval)}
\newcommand{\sourceTypeTupleX}[1]{(\symSetDatasetX{#1}, \symDataAccX{#1}, \evalX{#1})}
\newcommand{\sourceTypeTupleXXX}[3]{(\symSetDatasetX{#1}, \symDataAccX{#2}, \evalX{#3})}
